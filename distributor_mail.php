...
if(empty($_SESSION['4_letters_code'] ) ||
	  strcasecmp($_SESSION['4_letters_code'], $_POST['4_letters_code']) != 0)
	{
		...
		echo "var timer = setTimeout(function() { window.location='distributor-policy.html'}, 000); \n// --></script>";
	}
	else
	{
// ------- three variables you MUST change below  -------------------------------------------------------
$replyemail="chandraaruncropscience@gmail.com"; //change to your email address
$valid_ref1="distributor-policy.html";
$valid_ref2="distributor-policy.html"; //chamge to your domain name
...
function is_forbidden($str,$check_all_patterns = true)
{
 ...
 if ($forbidden)
 {
  echo "<font color=red><center><h3>STOP! Message not sent.</center></h3></font>";
   ...
   echo "<script language=\"JavaScript\"><!--\n ";
	echo "var timer = setTimeout(function() { window.location='distributor-policy.html'}, 1000); \n// --></script>";     
...
$themessage = $_POST['enqmes'];
    ...
    $message = "Chandra Arun Crop Science | Distributor New Enquiry";
